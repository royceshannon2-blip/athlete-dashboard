...
export function ProgressionDashboard({ isOpen, onClose }: ProgressionDashboardProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-end md:items-center md:justify-end md:p-4">
      <div className="w-full h-full md:h-auto md:max-w-3xl md:rounded-lg bg-slate-900 border md:border border-b-0 md:border-slate-700 flex flex-col overflow-hidden">
        ...
        {exercises.length === 0 ? (
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
            ...
            {selectedId && (
              <>
                <ExerciseProgressChart sessions={sessions} unit={weightLog.prefs.unit} />
